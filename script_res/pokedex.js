...
var POKEDEX_BW = $.extend(true, {}, POKEDEX_DPP, {
    ...
    "Jynx": { "ab": "Dry Skin", },
    "Electabuzz": { "ab": "Vital Spirit" },
    "Magmar": { "ab": "Vital Spirit" },
    "Ditto": { "ab": "Imposter", },
...
var POKEDEX_XY = $.extend(true, {}, POKEDEX_BW, {
    ...
    "Mewtwo": { "formes": ["Mewtwo", "Mega Mewtwo X", "Mega Mewtwo Y"], "ab": "Unnerve" },
    ...
    "Emboar": { "ab": "Reckless", },
    "Tornadus": { "ab": "Prankster", },
    "Landorus": { "ab": "Sand Force", },
    //stat buffs
    "Butterfree": { "bs": { "sa": 90 } },
...
var POKEDEX_SV_NATDEX = $.extend(true, {}, POKEDEX_SS_NATDEX, {
    ...
    "Bisharp": { "canEvolve": true, },

    "Gallade": { "ab": "Sharpness", },
...
[
    ...
    'Porygon', 'Chikorita', 'Bayleef', 'Meganium', 'Totodile', 'Croconaw', 'Feraligatr', 'Chinchou', 'Lanturn', 'Bellossom', 'Snubbull', 'Granbull',
    'Skarmory', 'Kingdra', 'Porygon2', 'Smeargle', 'Tyrogue', 'Hitmontop', 'Elekid', 'Magby', 'Raikou', 'Entei', 'Suicune', 'Lugia', 'Ho-Oh',
    'Treecko', 'Grovyle', 'Sceptile', 'Torchic', 'Combusken', 'Blaziken', 'Mudkip', 'Marshtomp', 'Swampert', 'Plusle', 'Minun',
    'Trapinch', 'Vibrava', 'Flygon', 'Beldum', 'Metang', 'Metagross', 'Regirock', 'Regice', 'Registeel', 'Latias', 'Latios',
    'Deoxys', 'Cranidos', 'Rampardos', 'Shieldon', 'Bastiodon', 'Rhyperior', 'Electivire',
    'Magmortar', 'Porygon-Z', 'Regigigas', 'Snivy', 'Servine', 'Serperior', 'Tepig', 'Pignite', 'Emboar', 'Blitzle', 'Zebstrika', 'Drilbur', 'Excadrill',
    'Cottonee', 'Whimsicott', 'Scraggy', 'Scrafty', 'Minccino', 'Cinccino', 'Solosis', 'Duosion', 'Reuniclus', 'Joltik', 'Galvantula', 'Golett', 'Golurk',
    'Cobalion', 'Terrakion', 'Virizion', 'Reshiram', 'Zekrom', 'Kyurem', 'Keldeo', 'Inkay', 'Malamar', 'Espurr', 'Meowstic', 'Litten',
    'Torracat', 'Incineroar', 'Popplio', 'Brionne', 'Primarina', 'Pikipek', 'Trumbeak', 'Toucannon', 'Dewpider', 'Araquanid', 'Comfey', 'Minior',
    'Cosmog', 'Cosmoem', 'Solgaleo', 'Lunala', 'Necrozma', 'Milcery', 'Alcremie', 'Duraludon', 'Hydrapple', 'Archaludon', 'Gouging Fire', 'Raging Bolt',
...
var POKEDEX_ZA_NATDEX = $.extend(true, {}, POKEDEX_SV_NATDEX, {
    //new form data
    "Clefable": { "formes": ["Clefable", "Mega Clefable"] },
    "Victreebel": { "formes": ["Victreebel", "Mega Victreebel"] },
    "Starmie": { "formes": ["Starmie", "Mega Starmie"] },
    "Dragonite": { "formes": ["Dragonite", "Mega Dragonite"] },
    "Meganium": { "formes": ["Meganium", "Mega Meganium"] },
    "Feraligatr": { "formes": ["Feraligatr", "Mega Feraligatr"] },
    "Skarmory": { "formes": ["Skarmory", "Mega Skarmory"] },
    "Froslass": { "formes": ["Froslass", "Mega Froslass"] },
    "Emboar": { "formes": ["Emboar", "Mega Emboar"] },
    "Excadrill": { "formes": ["Excadrill", "Mega Excadrill"] },
    "Scolipede": { "formes": ["Scolipede", "Mega Scolipede"] },
    "Scrafty": { "formes": ["Scrafty", "Mega Scrafty"] },
    "Eelektross": { "formes": ["Eelektross", "Mega Eelektross"] },
    "Chandelure": { "formes": ["Chandelure", "Mega Chandelure"] },
    "Chesnaught": { "formes": ["Chesnaught", "Mega Chesnaught"] },
    "Delphox": { "formes": ["Delphox", "Mega Delphox"] },
    "Greninja": { "formes": ["Greninja", "Mega Greninja"] },
    "Pyroar": { "formes": ["Pyroar", "Mega Pyroar"] },
    "Malamar": { "formes": ["Malamar", "Mega Malamar"] },
    "Barbaracle": { "formes": ["Barbaracle", "Mega Barbaracle"] },
    "Dragalge": { "formes": ["Dragalge", "Mega Dragalge"] },
    "Hawlucha": { "formes": ["Hawlucha", "Mega Hawlucha"] },
    ...
    "Floette-Eternal": {
        ...
        "w": 0.9,
        "ab": "Flower Veil",
        "formes": ["Floette-Eternal", "Mega Floette"]
    },
    "Mega Floette": {
        "t1": "Fairy",
        "bs": {
    ...
    "Zeraora": { "formes": ["Zeraora", "Mega Zeraora"] },
    "Scovillain": { "formes": ["Scovillain", "Mega Scovillain"] },
    "Glimmora": { "formes": ["Glimmora", "Mega Glimmora"] },
    "Tatsugiri": { "formes": ["Tatsugiri", "Mega Tatsugiri"] },
    "Baxcalibur": { "formes": ["Baxcalibur", "Mega Baxcalibur"] },
    //new Pokemon
    "Mega Raichu X": {
        "t1": "Electric",
        "bs": {
...
var POKEDEX_ZA = {};
[
    //Initial Pokemon Programmed into Legends Z-A
    'Chikorita', 'Bayleef', 'Meganium', 'Tepig', 'Pignite', 'Emboar', 'Totodile', 'Croconaw', 'Feraligatr', 'Fletchling', 'Fletchinder', 'Talonflame',
    'Bunnelby', 'Diggersby', 'Scatterbug', 'Spewpa', 'Vivillon', 'Weedle', 'Kakuna', 'Beedrill', 'Pidgey', 'Pidgeotto', 'Pidgeot',
    'Mareep', 'Flaaffy', 'Ampharos', 'Patrat', 'Watchog', 'Budew', 'Roselia', 'Roserade', 'Magikarp', 'Gyarados', 'Binacle', 'Barbaracle',
    'Staryu', 'Starmie', 'Flabebe', 'Floette', 'Florges', 'Skiddo', 'Gogoat', 'Espurr', 'Meowstic', 'Litleo', 'Pyroar',
    'Pancham', 'Pangoro', 'Trubbish', 'Garbodor', 'Dedenne', 'Pichu', 'Pikachu', 'Raichu', 'Cleffa', 'Clefairy', 'Clefable',
    'Spinarak', 'Ariados', 'Ekans', 'Arbok', 'Abra', 'Kadabra', 'Alakazam', 'Gastly', 'Haunter', 'Gengar', 'Venipede', 'Whirlipede', 'Scolipede',
    'Honedge', 'Doublade', 'Aegislash', 'Bellsprout', 'Weepinbell', 'Victreebel', 'Pansage', 'Simisage', 'Pansear', 'Simisear', 'Panpour', 'Simipour',
    'Meditite', 'Medicham', 'Electrike', 'Manectric', 'Ralts', 'Kirlia', 'Gardevoir', 'Gallade', 'Houndour', 'Houndoom', 'Swablu', 'Altaria',
    'Audino', 'Spritzee', 'Aromatisse', 'Swirlix', 'Slurpuff', 'Eevee', 'Vaporeon', 'Jolteon', 'Flareon', 'Espeon', 'Umbreon', 'Leafeon', 'Glaceon', 'Sylveon',
    'Buneary', 'Lopunny', 'Shuppet', 'Banette', 'Vanillite', 'Vanillish', 'Vanilluxe', 'Numel', 'Camerupt', 'Hippopotas', 'Hippowdon',
    'Drilbur', 'Excadrill', 'Sandile', 'Krokorok', 'Krookodile', 'Machop', 'Machoke', 'Machamp', 'Gible', 'Gabite', 'Garchomp', 'Carbink',
    'Sableye', 'Mawile', 'Absol', 'Riolu', 'Lucario', 'Slowpoke', 'Slowbro', 'Slowking', 'Carvanha', 'Sharpedo', 'Tynamo', 'Eelektrik', 'Eelektross',
    'Dratini', 'Dragonair', 'Dragonite', 'Bulbasaur', 'Ivysaur', 'Venusaur', 'Charmander', 'Charmeleon', 'Charizard', 'Squirtle', 'Wartortle', 'Blastoise',
    'Stunfisk', 'Furfrou', 'Inkay', 'Malamar', 'Skrelp', 'Dragalge', 'Clauncher', 'Clawitzer', 'Goomy', 'Sliggoo', 'Goodra', 'Delibird',
    ...
    'Stunfisk-Galar', 'Mega Malamar', 'Mega Dragalge', 'Sliggoo-Hisui', 'Goodra-Hisui', 'Mega Glalie', 'Mega Froslass', 'Mega Abomasnow', 'Avalugg-Hisui', 'Mega Scizor',
    'Mega Pinsir', 'Mega Heracross', 'Mega Hawlucha', 'Mega Scrafty', 'Mega Chandelure', 'Mega Aerodactyl', 'Mega Steelix', 'Mega Aggron',
    'Pumpkaboo-Small', 'Pumpkaboo-Large', 'Pumpkaboo-Super', 'Gourgeist-Small', 'Gourgeist-Large', 'Gourgeist-Super', 'Mega Tyranitar', 'Mega Greninja',
    'Mega Falinks', 'Mega Chesnaught', 'Mega Skarmory', 'Mega Delphox', 'Mega Salamence', 'Mega Kangaskhan', 'Mega Drampa', 'Mega Metagross', 'Zygarde-10%', 'Zygarde-Complete', 'Mega Zygarde',
    'Mega Mewtwo X', 'Mega Mewtwo Y', 'Mega Diancie', 'Hoopa-Unbound',
    //Mega Dimension DLC Pokemon
    'Mankey', 'Primeape', 'Annihilape', 'Meowth', 'Persian', 'Perrserker', "Farfetch'd", "Sirfetch'd", 'Cubone', 'Marowak', 'Porygon', 'Porygon2',
    'Porygon-Z', 'Capsakid', 'Scovillain', 'Tinkatink', 'Tinkatuff', 'Tinkaton', 'Cyclizar', 'Glimmet', 'Glimmora', 'Rotom', 'Greavard', 'Houndstone',
    'Sandygast', 'Palossand', 'Kecleon', 'Flamigo', 'Cryogonal', 'Dondozo', 'Tatsugiri', 'Frigibax', 'Arctibax', 'Baxcalibur', 'Gimmighoul', 'Gholdengo',
    'Qwilfish', 'Overqwil', 'Treecko', 'Grovyle', 'Sceptile', 'Torchic', 'Combusken', 'Blaziken', 'Mudkip', 'Marshtomp', 'Swampert', 'Feebas',
    'Milotic', 'Chingling', 'Chimecho', 'Indeedee', 'Purrloin', 'Liepard', 'Munna', 'Musharna', 'Throh', 'Sawk', 'Yamask', 'Cofagrigus',
    'Runerigus', 'Wimpod', 'Golisopod', 'Nickit', 'Thievul', 'Clobbopus', 'Grapploct', 'Mimikyu', 'Kleavor', 'Morpeko', 'Golett', 'Golurk',
    'Rookidee', 'Corvisquire', 'Corviknight', 'Igglybuff', 'Jigglypuff', 'Wigglytuff', 'Fidough', 'Dachsbun', 'Starly', 'Staravia', 'Staraptor', 'Spoink',
    'Grumpig', 'Squawkabilly', 'Crabrawler', 'Crabominable', 'Nacli', 'Naclstack', 'Garganacl', 'Gulpin', 'Swalot', 'Zubat', 'Golbat', 'Crobat',
    'Charcadet', 'Armarouge', 'Ceruledge', 'Maschiff', 'Mabosstiff', 'Toxel', 'Toxtricity', 'Shroodle', 'Grafaiai', 'Zangoose', 'Seviper', 'Mime Jr.',
...
[
    //Pokemon available from launch of Champions
    'Venusaur', 'Charizard', 'Blastoise', 'Beedrill', 'Pidgeot', 'Arbok', 'Pikachu', 'Raichu', 'Clefable', 'Ninetales',
    'Arcanine', 'Alakazam', 'Machamp', 'Victreebel', 'Slowbro', 'Gengar', 'Kangaskhan', 'Starmie', 'Pinsir',
    'Tauros', 'Gyarados', 'Ditto', 'Vaporeon', 'Jolteon', 'Flareon', 'Aerodactyl', 'Snorlax',
    'Dragonite', 'Meganium', 'Typhlosion', 'Feraligatr', 'Ariados', 'Ampharos', 'Azumarill', 'Politoed', 'Espeon',
    'Umbreon', 'Slowking', 'Forretress', 'Steelix', 'Scizor', 'Heracross', 'Skarmory', 'Houndoom', 'Tyranitar',
    'Pelipper', 'Gardevoir', 'Sableye', 'Aggron', 'Medicham', 'Manectric', 'Sharpedo', 'Camerupt', 'Torkoal', 'Altaria', 'Milotic', 'Castform',
    'Banette', 'Chimecho', 'Absol', 'Glalie', 'Torterra', 'Infernape', 'Empoleon', 'Luxray', 'Roserade', 'Rampardos', 'Bastiodon', 'Lopunny', 'Spiritomb', 'Garchomp', 'Lucario',
    'Hippowdon', 'Toxicroak', 'Abomasnow', 'Weavile', 'Rhyperior', 'Leafeon', 'Glaceon', 'Gliscor', 'Mamoswine',
    'Gallade', 'Froslass', 'Rotom', 'Serperior', 'Emboar', 'Samurott', 'Watchog', 'Liepard', 'Simisage', 'Simisear', 'Simipour', 'Excadrill', 'Audino',
    'Conkeldurr', 'Whimsicott', 'Krookodile', 'Cofagrigus', 'Garbodor', 'Zoroark', 'Reuniclus', 'Vanilluxe', 'Emolga', 'Chandelure', 'Beartic',
    'Stunfisk', 'Golurk', 'Hydreigon', 'Volcarona', 'Chesnaught', 'Delphox', 'Greninja', 'Diggersby',
    ...
    'Mega Dragonite', 'Mega Meganium', 'Typhlosion-Hisui', 'Mega Feraligatr', 'Mega Ampharos', 'Slowking-Galar', 'Mega Steelix', 'Mega Scizor',
    'Mega Heracross', 'Mega Skarmory', 'Mega Houndoom', 'Mega Tyranitar', 'Mega Gardevoir', 'Mega Sableye', 'Mega Aggron',
    'Mega Medicham', 'Mega Manectric', 'Mega Sharpedo', 'Mega Camerupt', 'Mega Altaria', 'Mega Banette', 'Mega Chimecho', 'Mega Absol', 'Mega Glalie',
